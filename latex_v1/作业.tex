\documentclass[lang=chs, degree=kcsj, blindreview=false, winfonts=true]{NWPUthesis}

%% degree：博士:phd，硕士:master，本科：bachelor，课程设计:kcsj
%%=============================================================================%
%% 导言区：请自行添加额外宏包
%%-----------------------------------------------------------------------------%
...
%%-----------------------------------------------------------------------------%
\subject{航天飞行动力学课程设计}{}
\title{基于Python语言的 \\ 一级半运载火箭弹道计算}{	% 中英文标题
	Yet Another Thesis Template of \\ Northwestern Polytechnical University
}	% 请自行断行
\author{\blindreview{李宗霖}}{\blindreview{Zonglin Li}}  % 姓名（添加盲评标记）
\date{2024年3月}{Mar 2024}	% 答辩日期
\school{教育实验学院}{Honors College}% 学院
\major{飞行器动力工程}{Flight Vehicle Propulsion Engineering}	% 专业 博士请添加 Ph
\advisor{\blindreview{闫晓东}}{\blindreview{Xiaodong Yan}}	% 导师（添加盲评标记）
\studentnumber{2021300045}	% 学号
...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.8]{../img/飞行高度.png}
    \caption{
        这里是个普通的标题
    }
    \label{fig:example}
...
\begin{figure}[htb]
    ...
    \begin{minipage}[t]{0.96\textwidth}
        ...
        \begin{subfigure}[t]{0.47\textwidth}
            \centering
            \includegraphics[scale=0.4]{../img/飞行高度.png}
...
\lstinputlisting[
    language = Python, 
    label = {code:makeBlindReviewerCommitteePage}, 
    caption={代码 main.py}
]{../code/main.py}
